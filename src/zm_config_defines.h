...
#define ZM_ENABLE_CSRF_MAGIC 9
#define ZM_OPT_USE_API 10
#define ZM_OPT_USE_GOOG_RECAPTCHA 11
#define ZM_OPT_GOOG_RECAPTCHA_SITEKEY 12
#define ZM_OPT_GOOG_RECAPTCHA_SECRETKEY 13
#define ZM_DIR_EVENTS 14
#define ZM_USE_DEEP_STORAGE 15
#define ZM_DIR_IMAGES 16
#define ZM_DIR_SOUNDS 17
#define ZM_PATH_ZMS 18
#define ZM_COLOUR_JPEG_FILES 19
#define ZM_ADD_JPEG_COMMENTS 20
#define ZM_JPEG_FILE_QUALITY 21
#define ZM_JPEG_ALARM_FILE_QUALITY 22
#define ZM_JPEG_IMAGE_QUALITY 23
#define ZM_JPEG_STREAM_QUALITY 24
#define ZM_MPEG_TIMED_FRAMES 25
#define ZM_MPEG_LIVE_FORMAT 26
#define ZM_MPEG_REPLAY_FORMAT 27
#define ZM_RAND_STREAM 28
#define ZM_OPT_CAMBOZOLA 29
#define ZM_PATH_CAMBOZOLA 30
#define ZM_RELOAD_CAMBOZOLA 31
#define ZM_TIMESTAMP_ON_CAPTURE 32
#define ZM_CPU_EXTENSIONS 33
#define ZM_FAST_IMAGE_BLENDS 34
#define ZM_OPT_ADAPTIVE_SKIP 35
#define ZM_MAX_SUSPEND_TIME 36
#define ZM_OPT_REMOTE_CAMERAS 37
#define ZM_NETCAM_REGEXPS 38
#define ZM_HTTP_VERSION 39
#define ZM_HTTP_UA 40
#define ZM_HTTP_TIMEOUT 41
#define ZM_MIN_RTP_PORT 42
#define ZM_MAX_RTP_PORT 43
#define ZM_OPT_FFMPEG 44
#define ZM_PATH_FFMPEG 45
#define ZM_FFMPEG_INPUT_OPTIONS 46
#define ZM_FFMPEG_OUTPUT_OPTIONS 47
#define ZM_FFMPEG_FORMATS 48
#define ZM_FFMPEG_OPEN_TIMEOUT 49
#define ZM_LOG_LEVEL_SYSLOG 50
#define ZM_LOG_LEVEL_FILE 51
#define ZM_LOG_LEVEL_WEBLOG 52
#define ZM_LOG_LEVEL_DATABASE 53
#define ZM_LOG_DATABASE_LIMIT 54
#define ZM_LOG_DEBUG 55
#define ZM_LOG_DEBUG_TARGET 56
#define ZM_LOG_DEBUG_LEVEL 57
#define ZM_LOG_DEBUG_FILE 58
#define ZM_LOG_CHECK_PERIOD 59
#define ZM_LOG_ALERT_WAR_COUNT 60
#define ZM_LOG_ALERT_ERR_COUNT 61
#define ZM_LOG_ALERT_FAT_COUNT 62
#define ZM_LOG_ALARM_WAR_COUNT 63
#define ZM_LOG_ALARM_ERR_COUNT 64
#define ZM_LOG_ALARM_FAT_COUNT 65
#define ZM_RECORD_EVENT_STATS 66
#define ZM_RECORD_DIAG_IMAGES 67
#define ZM_DUMP_CORES 68
#define ZM_PATH_MAP 69
#define ZM_PATH_SOCKS 70
#define ZM_PATH_LOGS 71
#define ZM_PATH_SWAP 72
#define ZM_PATH_ARP 73
#define ZM_WEB_TITLE_PREFIX 74
#define ZM_WEB_CONSOLE_BANNER 75
#define ZM_WEB_EVENT_DISK_SPACE 76
#define ZM_WEB_RESIZE_CONSOLE 77
#define ZM_WEB_ID_ON_CONSOLE 78
#define ZM_WEB_POPUP_ON_ALARM 79
#define ZM_OPT_X10 80
#define ZM_X10_DEVICE 81
#define ZM_X10_HOUSE_CODE 82
#define ZM_X10_DB_RELOAD_INTERVAL 83
#define ZM_WEB_SOUND_ON_ALARM 84
#define ZM_WEB_ALARM_SOUND 85
#define ZM_WEB_COMPACT_MONTAGE 86
#define ZM_OPT_FAST_DELETE 87
#define ZM_STRICT_VIDEO_CONFIG 88
#define ZM_LD_PRELOAD 89
#define ZM_SIGNAL_CHECK_POINTS 90
#define ZM_V4L_MULTI_BUFFER 91
#define ZM_CAPTURES_PER_FRAME 92
#define ZM_FILTER_RELOAD_DELAY 93
#define ZM_FILTER_EXECUTE_INTERVAL 94
#define ZM_OPT_UPLOAD 95
#define ZM_UPLOAD_ARCH_FORMAT 96
#define ZM_UPLOAD_ARCH_COMPRESS 97
#define ZM_UPLOAD_ARCH_ANALYSE 98
#define ZM_UPLOAD_PROTOCOL 99
#define ZM_UPLOAD_FTP_HOST 100
#define ZM_UPLOAD_HOST 101
#define ZM_UPLOAD_PORT 102
#define ZM_UPLOAD_FTP_USER 103
#define ZM_UPLOAD_USER 104
#define ZM_UPLOAD_FTP_PASS 105
#define ZM_UPLOAD_PASS 106
#define ZM_UPLOAD_FTP_LOC_DIR 107
#define ZM_UPLOAD_LOC_DIR 108
#define ZM_UPLOAD_FTP_REM_DIR 109
#define ZM_UPLOAD_REM_DIR 110
#define ZM_UPLOAD_FTP_TIMEOUT 111
#define ZM_UPLOAD_TIMEOUT 112
#define ZM_UPLOAD_STRICT 113
#define ZM_UPLOAD_FTP_PASSIVE 114
#define ZM_UPLOAD_FTP_DEBUG 115
#define ZM_UPLOAD_DEBUG 116
#define ZM_OPT_EMAIL 117
#define ZM_EMAIL_ADDRESS 118
#define ZM_EMAIL_TEXT 119
#define ZM_EMAIL_SUBJECT 120
#define ZM_EMAIL_BODY 121
#define ZM_OPT_MESSAGE 122
#define ZM_MESSAGE_ADDRESS 123
#define ZM_MESSAGE_TEXT 124
#define ZM_MESSAGE_SUBJECT 125
#define ZM_MESSAGE_BODY 126
#define ZM_NEW_MAIL_MODULES 127
#define ZM_EMAIL_HOST 128
#define ZM_FROM_EMAIL 129
#define ZM_URL 130
#define ZM_MAX_RESTART_DELAY 131
#define ZM_WATCH_CHECK_INTERVAL 132
#define ZM_WATCH_MAX_DELAY 133
#define ZM_RUN_AUDIT 134
#define ZM_AUDIT_CHECK_INTERVAL 135
#define ZM_AUDIT_MIN_AGE 136
#define ZM_FORCED_ALARM_SCORE 137
#define ZM_BULK_FRAME_INTERVAL 138
#define ZM_EVENT_CLOSE_MODE 139
#define ZM_FORCE_CLOSE_EVENTS 140
#define ZM_CREATE_ANALYSIS_IMAGES 141
#define ZM_WEIGHTED_ALARM_CENTRES 142
#define ZM_EVENT_IMAGE_DIGITS 143
#define ZM_DEFAULT_ASPECT_RATIO 144
#define ZM_USER_SELF_EDIT 145
#define ZM_OPT_CONTROL 146
#define ZM_OPT_TRIGGERS 147
#define ZM_CHECK_FOR_UPDATES 148
#define ZM_TELEMETRY_DATA 149
#define ZM_TELEMETRY_UUID 150
#define ZM_TELEMETRY_LAST_UPLOAD 151
#define ZM_UPDATE_CHECK_PROXY 152
#define ZM_SHM_KEY 153
#define ZM_WEB_REFRESH_METHOD 154
#define ZM_WEB_EVENT_SORT_FIELD 155
#define ZM_WEB_EVENT_SORT_ORDER 156
#define ZM_WEB_EVENTS_PER_PAGE 157
#define ZM_WEB_LIST_THUMBS 158
#define ZM_WEB_LIST_THUMB_WIDTH 159
#define ZM_WEB_LIST_THUMB_HEIGHT 160
#define ZM_WEB_USE_OBJECT_TAGS 161
#define ZM_WEB_H_REFRESH_MAIN 162
#define ZM_WEB_H_REFRESH_CYCLE 163
#define ZM_WEB_H_REFRESH_IMAGE 164
#define ZM_WEB_H_REFRESH_STATUS 165
#define ZM_WEB_H_REFRESH_EVENTS 166
#define ZM_WEB_H_CAN_STREAM 167
#define ZM_WEB_H_STREAM_METHOD 168
#define ZM_WEB_H_DEFAULT_SCALE 169
#define ZM_WEB_H_DEFAULT_RATE 170
#define ZM_WEB_H_VIDEO_BITRATE 171
#define ZM_WEB_H_VIDEO_MAXFPS 172
#define ZM_WEB_H_SCALE_THUMBS 173
#define ZM_WEB_H_EVENTS_VIEW 174
#define ZM_WEB_H_SHOW_PROGRESS 175
#define ZM_WEB_H_AJAX_TIMEOUT 176
#define ZM_WEB_M_REFRESH_MAIN 177
#define ZM_WEB_M_REFRESH_CYCLE 178
#define ZM_WEB_M_REFRESH_IMAGE 179
#define ZM_WEB_M_REFRESH_STATUS 180
#define ZM_WEB_M_REFRESH_EVENTS 181
#define ZM_WEB_M_CAN_STREAM 182
#define ZM_WEB_M_STREAM_METHOD 183
#define ZM_WEB_M_DEFAULT_SCALE 184
#define ZM_WEB_M_DEFAULT_RATE 185
#define ZM_WEB_M_VIDEO_BITRATE 186
#define ZM_WEB_M_VIDEO_MAXFPS 187
#define ZM_WEB_M_SCALE_THUMBS 188
#define ZM_WEB_M_EVENTS_VIEW 189
#define ZM_WEB_M_SHOW_PROGRESS 190
#define ZM_WEB_M_AJAX_TIMEOUT 191
#define ZM_WEB_L_REFRESH_MAIN 192
#define ZM_WEB_L_REFRESH_CYCLE 193
#define ZM_WEB_L_REFRESH_IMAGE 194
#define ZM_WEB_L_REFRESH_STATUS 195
#define ZM_WEB_L_REFRESH_EVENTS 196
#define ZM_WEB_L_CAN_STREAM 197
#define ZM_WEB_L_STREAM_METHOD 198
#define ZM_WEB_L_DEFAULT_SCALE 199
#define ZM_WEB_L_DEFAULT_RATE 200
#define ZM_WEB_L_VIDEO_BITRATE 201
#define ZM_WEB_L_VIDEO_MAXFPS 202
#define ZM_WEB_L_SCALE_THUMBS 203
#define ZM_WEB_L_EVENTS_VIEW 204
#define ZM_WEB_L_SHOW_PROGRESS 205
#define ZM_WEB_L_AJAX_TIMEOUT 206
#define ZM_DYN_LAST_VERSION 207
#define ZM_DYN_CURR_VERSION 208
#define ZM_DYN_DB_VERSION 209
#define ZM_DYN_LAST_CHECK 210
#define ZM_DYN_NEXT_REMINDER 211
#define ZM_DYN_DONATE_REMINDER_TIME 212
#define ZM_DYN_SHOW_DONATE_REMINDER 213
#define ZM_SSMTP_MAIL 214
#define ZM_SSMTP_PATH 215
...
#define ZM_CFG_DECLARE_LIST \
	...
	const char *web_console_banner;\
	const char *web_event_disk_space;\
	bool web_resize_console;\
	bool web_id_on_console;\
...
#define ZM_CFG_ASSIGN_LIST \
	...
	enable_csrf_magic = (bool)config.Item( ZM_ENABLE_CSRF_MAGIC );\
	...
	web_console_banner = (const char *)config.Item( ZM_WEB_CONSOLE_BANNER );\
	web_event_disk_space = (const char *)config.Item( ZM_WEB_EVENT_DISK_SPACE );\
	web_resize_console = (bool)config.Item( ZM_WEB_RESIZE_CONSOLE );\
	web_id_on_console = (bool)config.Item( ZM_WEB_ID_ON_CONSOLE );\
